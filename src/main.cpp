...
int main() {
    ...
    //     t->moverPieza(operaciones_bit::getSalida(x), operaciones_bit::getLlegada(x), operaciones_bit::getTipoDeJugada(x));
    //     cout << t->formatearJugada(x) << ": " << m->perft(2, t) << endl;
