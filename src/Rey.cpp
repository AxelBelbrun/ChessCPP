...
void Rey:: movimientos_legales(Tablero* tablero, std::vector<u_short>* movimientos,U64 rey, U64 piezasPropias, U64 piezasRivales) {
    ...
    if (((rey & AFile) == 0) && (((rey << 1) & (piezasPropias | piezasRivales)) == 0)) {
        movimientos->push_back(operaciones_bit::crearJugada(LSB, LSB + 1, QUIET));
    }
    ...
    if (((rey & fila8) == 0) && ((rey & HFile) == 0) && (((rey << 7) & (piezasPropias | piezasRivales)) == 0)) {
        movimientos->push_back(operaciones_bit::crearJugada(LSB, LSB + 7, QUIET));
    }
    ...
    if (((rey & fila8) == 0) && ((rey & AFile) == 0) && (((rey << 9) & (piezasPropias | piezasRivales)) == 0)) {
        movimientos->push_back(operaciones_bit::crearJugada(LSB, LSB + 9, QUIET));
    }
